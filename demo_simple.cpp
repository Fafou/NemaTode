...
int main(int argc, char** argv){
	...
	gps.onUpdate += [&gps](){
		cout << (gps.fix.main.locked() ? "[*] " : "[ ] ") << setw(2) << setfill(' ') << gps.fix.main.trackingSatellites << "/" << setw(2) << setfill(' ') << gps.fix.visibleSatellites << " ";
		...
		cout << fixed << setprecision(6) << gps.fix.main.latitude << "\xF8 " "N, " << gps.fix.main.longitude << "\xF8 " "E" << "  ";
